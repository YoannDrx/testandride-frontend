            ...
            <View style={styles.window}>
                ...
                <View style={styles.inputsContainer}>
                    <View style={styles.inputCont}>
                        <TextInput style={styles.input} placeholder="Email" onChangeText={(value) => setSignInEmail(value)} value={signInEmail} />
                        <FontAwesome name={"at"} style={styles.iconInput} size={20} color={mainColor} />
                    </View>
                    <View style={styles.inputCont}>
                        <TextInput style={styles.input} placeholder="Mot de passe" secureTextEntry={showPassword} onChangeText={(value) => setSignInPassword(value)} value={signInPassword} />
